...
const CONFIG = {
  ios_tokens_factory:'SLDSSpacing',
  tokens_file:'spacing.json'
};
...
gulp.task('spacing', () => {
  fs.writeFile(path.join(__PATHS__.temp, 'spacing.json'), '{"tempDir":'+'"'+__PATHS__.generated+'"}');
  return gulp.src(path.join(__PATHS__.temp, 'spacing.json'))
